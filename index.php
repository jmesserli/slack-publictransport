...
Flight::route("POST /api/v1/connections", function () use ($config) {
	...
	$matchCount = sizeof($regexMatches[0]);
	...
	if (sizeof($locations_from) > 1)
	{} // TODO ask to choose location
	else if (sizeof($locations_from) == 0)
	{} // TODO cancel and ask for better location

	if (sizeof($locations_to) > 1)
	{} // TODO ask to choose location
	else if (sizeof($locations_to) == 0)
	{} // TODO cancel and ask for better location
